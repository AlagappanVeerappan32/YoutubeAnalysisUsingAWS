...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "DB_NAME", table_name = "TABLE_NAME", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown)
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "YOUR PATH", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
